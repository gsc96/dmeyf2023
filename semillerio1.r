...
PARAM$finalmodel$learning_rate <- 0.0674767646119608
PARAM$finalmodel$feature_fraction <- 0.956527407383436
PARAM$finalmodel$min_data_in_leaf <- 44985
PARAM$finalmodel$num_leaves <- 384
