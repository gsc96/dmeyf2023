...
PARAM$experimento <- paste("joseleoisunbaltrue",metodo_imputacion,sep="_")

PARAM$input$dataset <- "competencia_03.csv"

# meses donde se entrena el modelo
PARAM$input$training <- c(202010,202011,202012, 202101, 202102, 202103,202104,202105,202106,202107)
PARAM$input$future <- c(202109) # meses donde se aplica el modelo

PARAM$finalmodel$semilla <- c(100043)
...
# Chequeo nulos
sum(is.na(dataset[foto_mes %in% c(202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107,202109)]))
