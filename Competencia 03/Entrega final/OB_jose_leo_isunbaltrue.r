...
dataset[foto_mes %in% c(202010, 202104), mcajeros_propios_descuentos := NA]
dataset[foto_mes %in% c(202010, 202104), ctarjeta_visa_descuentos := NA]
dataset[foto_mes %in% c(202010, 202104), mtarjeta_visa_descuentos := NA]
dataset[foto_mes %in% c(202010, 202104), ctarjeta_master_descuentos := NA]
dataset[foto_mes %in% c(202010, 202104), mtarjeta_master_descuentos := NA]
dataset[foto_mes == 202107, ccajas_depositos := NA]

#------------------------------------------------------------------------------
#Imputación de nulos

taining_subset <- dataset[foto_mes %in% c(202010, 202011, 202012, 202101, 202102, 202103, 202104), ..campos_buenos]
...
# Chequeo nulos
sum(is.na(dataset[foto_mes %in% c(202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105, 202106, 202107)]))
